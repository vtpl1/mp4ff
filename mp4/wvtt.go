...
func DecodeWvttSR(hdr BoxHeader, startPos uint64, sr bits.SliceReader) (Box, error) {
	...
	endPos := startPos + uint64(hdr.Hdrlen+hdr.payloadLen()) //nolint:gosec
	for {
		if pos >= endPos {
			break
		}
		...
		if box != nil {
			...
			return nil, errors.New("no child of wvtt")
		}
	}
	return &w, nil
}
...
func DecodeVttCSR(hdr BoxHeader, _ uint64, sr bits.SliceReader) (Box, error) {
...
func (b *VttCBox) Size() uint64 {
	return uint64(boxHeaderSize + len(b.Config)) //nolint:gosec
}
...
// Info - write box-specific information
func (b *VttCBox) Info(w io.Writer, _ string, indent string, _ string) error {
	bd := newInfoDumper(w, indent, b, -1, 0)
...
func DecodeVlabSR(hdr BoxHeader, _ uint64, sr bits.SliceReader) (Box, error) {
...
func (b *VlabBox) Size() uint64 {
	return uint64(boxHeaderSize + len(b.SourceLabel)) //nolint:gosec
}
...
// Info - write box-specific information
func (b *VlabBox) Info(w io.Writer, _ string, indent string, _ string) error {
	bd := newInfoDumper(w, indent, b, -1, 0)
...
func DecodeVtte(_ BoxHeader, _ uint64, _ io.Reader) (Box, error) {
	return &VtteBox{}, nil
}

// DecodeVtteSR - box-specific decode
func DecodeVtteSR(_ BoxHeader, _ uint64, _ bits.SliceReader) (Box, error) {
	return &VtteBox{}, nil
}
...
// Info - write box-specific information
func (b *VtteBox) Info(w io.Writer, _ string, indent string, _ string) error {
	bd := newInfoDumper(w, indent, b, -1, 0)
	return bd.err
}
...
func DecodeVsidSR(_ BoxHeader, _ uint64, sr bits.SliceReader) (Box, error) {
...
// Info - write box-specific information
func (b *VsidBox) Info(w io.Writer, _ string, indent string, _ string) error {
	bd := newInfoDumper(w, indent, b, -1, 0)
...
func DecodeCtimSR(hdr BoxHeader, _ uint64, sr bits.SliceReader) (Box, error) {
...
func (b *CtimBox) Size() uint64 {
	return uint64(boxHeaderSize + len(b.CueCurrentTime)) //nolint:gosec
}
...
// Info - write box-specific information
func (b *CtimBox) Info(w io.Writer, _ string, indent string, _ string) error {
	bd := newInfoDumper(w, indent, b, -1, 0)
...
func DecodeIdenSR(hdr BoxHeader, _ uint64, sr bits.SliceReader) (Box, error) {
...
func (b *IdenBox) Size() uint64 {
	return uint64(boxHeaderSize + len(b.CueID)) //nolint:gosec
}
...
// Info - write box-specific information
func (b *IdenBox) Info(w io.Writer, _ string, indent string, _ string) error {
	bd := newInfoDumper(w, indent, b, -1, 0)
...
func DecodeSttgSR(hdr BoxHeader, _ uint64, sr bits.SliceReader) (Box, error) {
...
func (b *SttgBox) Size() uint64 {
	return uint64(boxHeaderSize + len(b.Settings)) //nolint:gosec
}
...
// Info - write box-specific information
func (b *SttgBox) Info(w io.Writer, _ string, indent string, _ string) error {
	bd := newInfoDumper(w, indent, b, -1, 0)
...
func DecodePaylSR(hdr BoxHeader, _ uint64, sr bits.SliceReader) (Box, error) {
...
func (b *PaylBox) Size() uint64 {
	return uint64(boxHeaderSize + len(b.CueText)) //nolint:gosec
}
...
// Info - write box-specific information
func (b *PaylBox) Info(w io.Writer, _ string, indent string, _ string) error {
	bd := newInfoDumper(w, indent, b, -1, 0)
...
func DecodeVttaSR(hdr BoxHeader, _ uint64, sr bits.SliceReader) (Box, error) {
...
func (b *VttaBox) Size() uint64 {
	return uint64(boxHeaderSize + len(b.CueAdditionalText)) //nolint:gosec
}
...
// Info - write box-specific information
func (b *VttaBox) Info(w io.Writer, _ string, indent string, _ string) error {
	bd := newInfoDumper(w, indent, b, -1, 0)
