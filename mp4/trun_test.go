...
func TestGetSampleInterval(t *testing.T) {
	...
	mdat := mp4.MdatBox{LazyDataSize: 28000}
	...
	testCases := []struct {
		...
		{
			1, 2, 10000, &mdat, 0, mp4.SampleInterval{10000, []mp4.Sample{{0, 100, 1000, 0}, {0, 200, 2000, 0}}, 0, 3000, nil},
		},
		{
			3, 4, 10000, &mdat, 0, mp4.SampleInterval{10300, []mp4.Sample{{0, 300, 3000, 0}, {0, 400, 4000, 0}}, 3000, 7000, nil},
		},
	}
